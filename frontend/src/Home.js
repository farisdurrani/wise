...
const Home = () => {
  ...
  return (
    ...
    <div className="selectionSection">
      ...
      <div className="carousel_parent">
        <div className="carousel">
          ...
          <img src={meditations} alt="" className="carouselItem meditations"/>
    ...
    <div className="userProblem">
      <input type="text" onBlur={handleQuestion} placeholder="Tell us your problem..."/>
      <img src={enterImage} onClick={handleClick}
